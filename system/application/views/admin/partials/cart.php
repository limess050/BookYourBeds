...
if( ! empty($_r)) { ?>
<div class="alert">
	<h3>Currently Booking <small><?php echo anchor('admin/salesdesk/index', 'Change') . ' | ' . anchor('admin/salesdesk/confirm', 'Continue'); ?> | </small><a href="<?php echo site_url('admin/salesdesk/reset'); ?>" onclick="return confirm('Are you sure you want to cancel this booking?');" class="btn btn-danger btn-small">Cancel</a></h3>
