...
if( ! empty($_r)) { ?>
<div class="alert">
	<h3>Currently Booking <small><?php echo anchor('salesdesk/index', 'Change'); ?></small></h3>
	...
	<table class="table table-condensed">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<?php echo site_url('salesdesk/reset'); ?>" class="btn btn-danger btn-small">Cancel</a></td>
			</tr>
			<?php } ?>
		</tbody>
